...
exports.REMITO_RULES = void 0;
exports.validateRemito = validateRemito;
 ...
 */
function validateRemito(fields, requiredFields) {
    const errors = [];
    ...
    for (const rule of exports.REMITO_RULES) {
        ...
        if (!value)
            continue; // campo opcional y vacío → no aplicar formato
...
//# sourceMappingURL=remito.rules.js.map