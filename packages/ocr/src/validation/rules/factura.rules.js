...
exports.FACTURA_RULES = void 0;
exports.validateFactura = validateFactura;
...
function isValidFacturaNumber(value) {
...
exports.FACTURA_RULES = [
    // Formato número de comprobante
    {
        field: 'numero',
        validate: (v) => v && !isValidFacturaNumber(v)
 ...
 */
function validateFactura(fields, requiredFields) {
    const errors = [];
    ...
    for (const rule of exports.FACTURA_RULES) {
...
//# sourceMappingURL=factura.rules.js.map