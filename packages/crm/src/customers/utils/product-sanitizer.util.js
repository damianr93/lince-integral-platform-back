...
exports.PRODUCT_NAME_MAP = void 0;
exports.sanitizeProductName = sanitizeProductName;
exports.PRODUCT_NAME_MAP = {
...
function sanitizeProductName(productName) {
    ...
    if (exports.PRODUCT_NAME_MAP[productStr]) {
        return exports.PRODUCT_NAME_MAP[productStr];
    }
...
//# sourceMappingURL=product-sanitizer.util.js.map